...
import org.eclipse.smarthome.core.thing.dto.ConfigDescriptionParameterDTO;
import org.eclipse.smarthome.core.thing.dto.FilterCriteriaDTO;
import org.eclipse.smarthome.core.thing.dto.ParameterGroupDTO;
import org.eclipse.smarthome.core.thing.dto.ParameterOptionDTO;
...
public class ThingTypeResource implements RESTResource {
    ...
    private List<ParameterGroupDTO> convertToParameterGroupBeans(URI configDescriptionURI, Locale locale) {

        ConfigDescription configDescription = configDescriptionRegistry.getConfigDescription(configDescriptionURI,
                locale);
        List<ParameterGroupDTO> parameterGroupBeans = new ArrayList<>();
        if (configDescription != null) {
            ...
            for (ConfigDescriptionParameterGroup parameterGroup : parameterGroups) {
                parameterGroupBeans.add(new ParameterGroupDTO(parameterGroup.getName(), parameterGroup.getContext(),
