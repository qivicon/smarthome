...
/**
 * {@link DefaultConfigDescriptionI18nProvider} is the default
 ...
 */
public class DefaultConfigDescriptionI18nProvider extends ContextSpecificI18nProvider implements
        ConfigDescriptionI18nProvider {
    ...
    public String getParameterLabel(Bundle bundle, URI configDescriptionURI, String parameterName, String defaultLabel,
            Locale locale) {
        String key = isConstant(defaultLabel) ? stripConstant(defaultLabel) : inferKey(configDescriptionURI,
                parameterName, "label");
