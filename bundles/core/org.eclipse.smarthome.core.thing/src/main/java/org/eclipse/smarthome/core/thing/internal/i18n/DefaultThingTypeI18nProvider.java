...
public class DefaultThingTypeI18nProvider implements ThingTypeI18nProvider {
	...
	@Override
	public String getChannelLabel(ChannelTypeUID channelTypeUID, String defaultLabel, Locale locale) {
		return i18nProvider.getText(channelTypeUID.getBindingId(), "channel-type." + channelTypeUID.getId() + ".label",
				defaultLabel, locale);
	}

	@Override
	public String getChannelDescription(ChannelTypeUID channelTypeUID, String defaultDescription, Locale locale) {
		return i18nProvider.getText(channelTypeUID.getBindingId(), "channel-type." + channelTypeUID.getId()
