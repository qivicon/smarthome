...
/**
 * A {@link StatusInfo} represents status information of a thing which consists of
 * <ul>
...
public class StatusInfo {
     ...
     */
    public StatusInfo(ThingStatus status, ThingStatusDetail statusDetail, String description) {
        this.status = status;
