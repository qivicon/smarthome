 ...
 * <p>
 * This class should be used for each type definition which inherits from the
 * {@link AbstractDescriptionType} class.
 *
...
public abstract class AbstractDescriptionTypeConverter<T> extends GenericUnmarshaller<T> {
   ...
   /**
    * Returns the value of the {@code config-description-ref} and the {@code config-description}
    * tags from the specific XML type definition. 
    * 
    * @param nodeIterator the iterator to be used to extract the information (must not be null)
    * 
    ...
    */
     ...
     */
    protected abstract T unmarshalType(
