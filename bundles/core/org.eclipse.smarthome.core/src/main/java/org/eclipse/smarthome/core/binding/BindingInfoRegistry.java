 ...
 * It tracks {@link BindingInfoProvider} <i>OSGi</i> services to collect all
 * {@link BindingInfo} objects.
 * 
...
public class BindingInfoRegistry {
    ...
    /**
     * Returns the binding information for the specified binding ID, or {@code null}
     * if no binding information could be found.
     * 
